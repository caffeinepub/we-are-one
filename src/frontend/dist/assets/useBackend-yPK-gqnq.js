...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const LineupInput2 = IDL2.Record({
    "day": IDL2.Opt(IDL2.Text),
    "weekend": IDL2.Opt(IDL2.Text),
    "stage": IDL2.Text,
...
class Backend {
  ...
  async addLineupEntry(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.addLineupEntry(to_candid_LineupInput_n11(this._uploadFile, this._downloadFile, arg0));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async addNightclubEvent(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.addNightclubEvent(to_candid_NightclubEventInput_n13(this._uploadFile, this._downloadFile, arg0));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async addNightclubSet(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.addNightclubSet(to_candid_NightclubSetInput_n15(this._uploadFile, this._downloadFile, arg0));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async addPackage(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.addPackage(to_candid_PackageInput_n17(this._uploadFile, this._downloadFile, arg0));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async addRaveEvent(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.addRaveEvent(to_candid_RaveEventInput_n21(this._uploadFile, this._downloadFile, arg0));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async addRaveSet(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.addRaveSet(to_candid_RaveSetInput_n23(this._uploadFile, this._downloadFile, arg0));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async addSiteEvent(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.addSiteEvent(to_candid_SiteEventInput_n25(this._uploadFile, this._downloadFile, arg0));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async updateLineupEntry(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.updateLineupEntry(arg0, to_candid_LineupInput_n11(this._uploadFile, this._downloadFile, arg1));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async updateNightclubEvent(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.updateNightclubEvent(arg0, to_candid_NightclubEventInput_n13(this._uploadFile, this._downloadFile, arg1));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async updateNightclubSet(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.updateNightclubSet(arg0, to_candid_NightclubSetInput_n15(this._uploadFile, this._downloadFile, arg1));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async updatePackage(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.updatePackage(arg0, to_candid_PackageInput_n17(this._uploadFile, this._downloadFile, arg1));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async updateRaveEvent(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.updateRaveEvent(arg0, to_candid_RaveEventInput_n21(this._uploadFile, this._downloadFile, arg1));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async updateRaveSet(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.updateRaveSet(arg0, to_candid_RaveSetInput_n23(this._uploadFile, this._downloadFile, arg1));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async updateSiteEvent(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.updateSiteEvent(arg0, to_candid_SiteEventInput_n25(this._uploadFile, this._downloadFile, arg1));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
...
function from_candid_DonationGoal_n30(_uploadFile, _downloadFile, value) {
  return from_candid_record_n31(_uploadFile, _downloadFile, value);
}
function from_candid_EventType_n41(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n42(_uploadFile, _downloadFile, value);
}
function from_candid_FestivalStatus_n37(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n38(_uploadFile, _downloadFile, value);
}
function from_candid_Festival_n35(_uploadFile, _downloadFile, value) {
  return from_candid_record_n36(_uploadFile, _downloadFile, value);
}
function from_candid_LineupEntry_n45(_uploadFile, _downloadFile, value) {
  return from_candid_record_n46(_uploadFile, _downloadFile, value);
}
function from_candid_NightclubEvent_n49(_uploadFile, _downloadFile, value) {
  return from_candid_record_n50(_uploadFile, _downloadFile, value);
}
function from_candid_NightclubSet_n53(_uploadFile, _downloadFile, value) {
  return from_candid_record_n54(_uploadFile, _downloadFile, value);
}
function from_candid_PackageType_n59(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n60(_uploadFile, _downloadFile, value);
}
function from_candid_Package_n57(_uploadFile, _downloadFile, value) {
  return from_candid_record_n58(_uploadFile, _downloadFile, value);
}
function from_candid_RaveEvent_n63(_uploadFile, _downloadFile, value) {
  return from_candid_record_n64(_uploadFile, _downloadFile, value);
}
function from_candid_RaveSet_n67(_uploadFile, _downloadFile, value) {
  return from_candid_record_n68(_uploadFile, _downloadFile, value);
}
function from_candid_Season_n39(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n40(_uploadFile, _downloadFile, value);
}
function from_candid_SiteEvent_n71(_uploadFile, _downloadFile, value) {
...
function from_candid_opt_n29(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : from_candid_DonationGoal_n30(_uploadFile, _downloadFile, value[0]);
}
function from_candid_opt_n32(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : value[0];
}
function from_candid_opt_n34(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : from_candid_Festival_n35(_uploadFile, _downloadFile, value[0]);
}
function from_candid_opt_n47(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : value[0];
}
function from_candid_opt_n48(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : from_candid_NightclubEvent_n49(_uploadFile, _downloadFile, value[0]);
}
function from_candid_opt_n52(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : from_candid_NightclubSet_n53(_uploadFile, _downloadFile, value[0]);
}
function from_candid_opt_n61(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : value[0];
}
function from_candid_opt_n62(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : from_candid_RaveEvent_n63(_uploadFile, _downloadFile, value[0]);
}
function from_candid_opt_n66(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : from_candid_RaveSet_n67(_uploadFile, _downloadFile, value[0]);
}
function from_candid_opt_n70(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : from_candid_SiteEvent_n71(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n31(_uploadFile, _downloadFile, value) {
  return {
    ...
    festivalId: record_opt_to_undefined(from_candid_opt_n32(_uploadFile, _downloadFile, value.festivalId)),
...
function from_candid_record_n36(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    status: from_candid_FestivalStatus_n37(_uploadFile, _downloadFile, value.status),
    country: value.country,
    ticketPriceMax: value.ticketPriceMax,
    ticketPriceMin: value.ticketPriceMin,
    weekends: value.weekends,
    name: value.name,
    ticketUrl: record_opt_to_undefined(from_candid_opt_n27(_uploadFile, _downloadFile, value.ticketUrl)),
    description: record_opt_to_undefined(from_candid_opt_n27(_uploadFile, _downloadFile, value.description)),
    season: from_candid_Season_n39(_uploadFile, _downloadFile, value.season),
    ...
    lineup: record_opt_to_undefined(from_candid_opt_n27(_uploadFile, _downloadFile, value.lineup)),
    specialNotes: record_opt_to_undefined(from_candid_opt_n27(_uploadFile, _downloadFile, value.specialNotes)),
...
function from_candid_record_n46(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    day: record_opt_to_undefined(from_candid_opt_n27(_uploadFile, _downloadFile, value.day)),
    weekend: record_opt_to_undefined(from_candid_opt_n27(_uploadFile, _downloadFile, value.weekend)),
    stage: value.stage,
...
function from_candid_record_n50(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    categoryId: record_opt_to_undefined(from_candid_opt_n32(_uploadFile, _downloadFile, value.categoryId)),
    date: value.date,
    name: value.name,
    createdAt: value.createdAt,
    ticketUrl: record_opt_to_undefined(from_candid_opt_n27(_uploadFile, _downloadFile, value.ticketUrl)),
...
function from_candid_record_n54(_uploadFile, _downloadFile, value) {
  return {
    ...
    stage: value.stage,
    artistName: value.artistName,
    youtubeUrl: record_opt_to_undefined(from_candid_opt_n27(_uploadFile, _downloadFile, value.youtubeUrl))
  };
}
function from_candid_record_n58(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    packageType: from_candid_PackageType_n59(_uploadFile, _downloadFile, value.packageType),
    name: value.name,
    description: value.description,
    includes: value.includes,
    festivalId: record_opt_to_undefined(from_candid_opt_n61(_uploadFile, _downloadFile, value.festivalId)),
...
function from_candid_vec_n33(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_DonationGoal_n30(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n43(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_Festival_n35(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n44(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_LineupEntry_n45(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n51(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_NightclubEvent_n49(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n55(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_NightclubSet_n53(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n56(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_Package_n57(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n65(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_RaveEvent_n63(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n69(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_RaveSet_n67(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n73(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_SiteEvent_n71(_uploadFile, _downloadFile, x));
}
...
function to_candid_LineupInput_n11(_uploadFile, _downloadFile, value) {
  return to_candid_record_n12(_uploadFile, _downloadFile, value);
}
function to_candid_NightclubEventInput_n13(_uploadFile, _downloadFile, value) {
  return to_candid_record_n14(_uploadFile, _downloadFile, value);
}
function to_candid_NightclubSetInput_n15(_uploadFile, _downloadFile, value) {
  return to_candid_record_n16(_uploadFile, _downloadFile, value);
}
function to_candid_PackageInput_n17(_uploadFile, _downloadFile, value) {
  return to_candid_record_n18(_uploadFile, _downloadFile, value);
}
function to_candid_PackageType_n19(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n20(_uploadFile, _downloadFile, value);
}
function to_candid_RaveEventInput_n21(_uploadFile, _downloadFile, value) {
  return to_candid_record_n22(_uploadFile, _downloadFile, value);
}
function to_candid_RaveSetInput_n23(_uploadFile, _downloadFile, value) {
...
function to_candid_SiteEventInput_n25(_uploadFile, _downloadFile, value) {
  return to_candid_record_n26(_uploadFile, _downloadFile, value);
}
function to_candid_record_n12(_uploadFile, _downloadFile, value) {
  return {
    day: value.day ? candid_some(value.day) : candid_none(),
    weekend: value.weekend ? candid_some(value.weekend) : candid_none(),
    stage: value.stage,
    festivalId: value.festivalId,
    artistName: value.artistName,
    timeSlot: value.timeSlot
...
function to_candid_record_n18(_uploadFile, _downloadFile, value) {
  return {
    packageType: to_candid_PackageType_n19(_uploadFile, _downloadFile, value.packageType),
    name: value.name,
    description: value.description,
    includes: value.includes,
    festivalId: value.festivalId ? candid_some(value.festivalId) : candid_none(),
